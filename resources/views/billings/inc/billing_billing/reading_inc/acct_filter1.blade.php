...
<div class="filter_1">
	...
	<input type="text"  class="gg1" placeholder="Account Number" id="search_acct_num"    value="<?php  echo  (@$acct_num != 'none' && !empty(@$acct_num))  ? @$acct_num: ''; ?>">
	<input type="text"  class="gg1" placeholder="Meter Number" id="search_meter_num"   value="<?php echo  (@$meter_num != 'none' && !empty(@$meter_num))  ? @$meter_num: ''; ?>">
	<input type="text"  class="gg1" placeholder="Last Name" id="search_last_name"  value="<?php echo  (@$lname != 'none' && !empty(@$lname))  ? @$lname: ''; ?>">
...
function go_period_search(){
	...
	window.location = '/billing/billing/'+period_year+'/'+period_month+hash;
}
...
function go_reading_filter(){
	...
	window.location='/billing/billing/<?php echo $r_year; ?>/<?php echo $r_month; ?>'+'/filter'+$url_part1+hash;	
