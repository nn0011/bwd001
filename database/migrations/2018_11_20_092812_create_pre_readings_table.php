...
class CreatePreReadingsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('pre_readings', function (Blueprint $table) {
            $table->increments('id');
             ...
             $table->string('Q', 50)->nullable()->default('');
    ...
    {
        Schema::dropIfExists('pre_readings');
    }
}
